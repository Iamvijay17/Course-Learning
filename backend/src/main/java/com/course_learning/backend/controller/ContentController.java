...
public class ContentController {
    ...
    @Operation(summary = "Get modules for a course", description = "Retrieve all modules for a specific course")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getModulesByCourse(@RequestHeader(value = "Authorization", required = false) String token,
        ...
        try {
            ...
            List<Module> modules = contentService.getModulesByCourse(courseId, instructorId);
    ...
    @Operation(summary = "Create a new module", description = "Create a new module for a specific course")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> createModule(@RequestHeader(value = "Authorization", required = false) String token,
        ...
        try {
            ...
            Module createdModule = contentService.createModule(courseId, moduleData, instructorId);
